...
//    }
    ...
    public static UrlResp post(String url, Object... params) {
        ...
        Object postDatastr = null;

        Object headers = null;
        Object cookies = null;
        Object postFile = null;
        ...
        return request(url, query, postData, postDatastr, Method.POST, headers, cookies, postFile);
    }
    ...
    private static void parseParams(Urllib urllib, Object[] params) {
        ...
        if (paramLength > 2) {
            ...
            if (param instanceof Map)
                urllib.setPostData((String) param);
        }
        if (paramLength > 3) {
        ...
        if (paramLength > 5) {
            Object param = params[5];
            if (param instanceof String)
                urllib.setCookies((String) param);
        }
        if (paramLength > 6) {
            Object param = params[6];
            if (param instanceof String)
                urllib.setuploadFile((String) param);
        }
    }
...
//                out.close();
                ...
                conn.setUseCaches(false);
                OutputStream out = new DataOutputStream(conn.getOutputStream());
                out.write(postDatastr.getBytes());
                out.flush();
                out.close();
...
//        else if (ContentType.contains("json"))
    ...
    public Urllib addHeader(Map header) {
        headers = header;
        return this;
    }
    ...
    public Urllib setProxy(String proxymap) {
        this.isproxy = true;
        this.proxyhost = proxymap.split(":")[0];
        this.proxyport = Integer.parseInt(proxymap.split(":")[1]);
        return this;
    }
    ...
    public Urllib setPostData(String postDatastr) {
        this.strPostData = true;
        if (postDatastr == null)
            throw new IllegalArgumentException("data不能为空");
    ...
    public Urllib setuploadFile(String fileName) {
        //换行符
        ...
        this.sb.append(boundaryPrefix);
        this.sb.append(BOUNDARY);
        this.sb.append(newLine);
        this.sb.append("Content-Disposition: form-data;name=\"photo\";filename=\"" + fileName
                + "\"" + newLine);
        ...
        this.sb.append(newLine);
        this.sb.append(newLine);
        this.sb.append(boundaryPrefix + BOUNDARY + boundaryPrefix);
        this.isupload = true;
        return this;
    }
